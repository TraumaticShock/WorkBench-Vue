<template>
    <div class="category-item">
        ...
        <div v-if="category.children?.length && category.expanded" class="ml-6 mt-1 border-l-2 border-base-200 pl-2">
            <TodoCategoryTreeItem v-for="child in category.children" :key="child.id" :category="child"
...
// 递归引用自身组件
const TodoCategoryTreeItem = defineAsyncComponent(() => import('./TodoCategoryTreeItem.vue'));
